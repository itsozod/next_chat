...
import CreateRoomModal from "@/features/chat/ui/rooms/CreateRoom/CreateRoomModal";
import Rooms from "@/features/chat/ui/rooms/Rooms";
    ...
    <aside className="no-scrollbar sticky top-0 bottom-0 overflow-auto h-[100vh] w-20 lg:w-[400px] border-r border-base-300 flex flex-col transition-all duration-200">
      {isLoading ? (
        ...
        <>
          ...
          <CreateRoomModal />
          <Rooms
            className="flex flex-col gap-3 items-start overflow-y-auto py-3"
            rooms={rooms}
